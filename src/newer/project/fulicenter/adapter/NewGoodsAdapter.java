...
public class NewGoodsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NewGoodsAdapter(Context context, ArrayList<NewGoodBean> goodsList, int sortBy) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_GOODS:
                layout = LayoutInflater.from(context).inflate(R.layout.item_new_goods, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        switch (getItemViewType(position)) {
            case TYPE_GOODS:
                ...
                newGoodsHolder.mtvNewGoodsDetail.setText(goodsList.get(position).getGoodsName());
                newGoodsHolder.mtvNewGoodsPrice.setText(goodsList.get(position).getCurrencyPrice());
                ImageUtils.setGoodsPicture(newGoodsHolder.mnivNewGoods, goodsList.get(position).getGoodsThumb());
                newGoodsHolder.mLayoutNewGoods.setOnClickListener(new View.OnClickListener() {
                    @Override
    ...
    class NewGoodsHolder extends RecyclerView.ViewHolder {
        NetworkImageView mnivNewGoods;
        TextView mtvNewGoodsDetail,mtvNewGoodsPrice;
        LinearLayout mLayoutNewGoods;

        public NewGoodsHolder(View itemView) {
            super(itemView);
            mnivNewGoods = (NetworkImageView) itemView.findViewById(R.id.niv_new_goods);
            mtvNewGoodsDetail = (TextView) itemView.findViewById(R.id.tv_new_goods_detail);
            mtvNewGoodsPrice = (TextView) itemView.findViewById(R.id.tv_new_goods_price);
            mLayoutNewGoods = (LinearLayout) itemView.findViewById(R.id.layout_new_goods);
        }
    }
}
