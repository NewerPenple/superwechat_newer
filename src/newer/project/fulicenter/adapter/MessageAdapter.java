...
import newer.project.fulicenter.activity.AlertDialog;
import newer.project.fulicenter.activity.BaiduMapActivity;
import newer.project.fulicenter.activity.ChatActivity;
import newer.project.fulicenter.activity.ContextMenu;
import newer.project.fulicenter.activity.ShowBigImage;
import newer.project.fulicenter.activity.ShowNormalFileActivity;
import newer.project.fulicenter.activity.ShowVideoActivity;
import newer.project.fulicenter.activity.UserProfileActivity;
import newer.project.fulicenter.applib.controller.HXSDKHelper;
import newer.project.fulicenter.task.LoadImageTask;
import newer.project.fulicenter.task.LoadVideoImageTask;
import newer.project.fulicenter.utils.DateUtils;
import newer.project.fulicenter.utils.ImageCache;
import newer.project.fulicenter.utils.ImageUtils;
import newer.project.fulicenter.utils.SmileUtils;
	...
	private void setUserAvatar(final EMMessage message, NetworkImageView imageView){
	    if(message.direct == Direct.SEND){
			...
			if (message.getChatType() == ChatType.GroupChat) {
				...
				UserUtils.setContactAvatar(message.getFrom(), imageView);
			}
		}
