package newer.project.fulicenter.data;
...
public class OkHttpUtils3<T> {
     ...
     */
    public OkHttpUtils3<T> url(String url) {
        mUrl.append(url);
        return this;
    }
     ...
     * @return OkHttpUtils2.this
     */
    public OkHttpUtils3<T> addParam(String key, String value) {
        try {
            if (mUrl.indexOf("?") == -1) {
     ...
     * @return OkHttpUtils2.this
     */
    public OkHttpUtils3<T> addFile(File file) {
     ...
     * @return
     */
    public OkHttpUtils3<T> doInBackground(Callback callback) {
        if (callback != null) {
            mCallback = callback;
        }
        return this;
     ...
     * @return
     */
    public OkHttpUtils3<T> onPreExecute(Runnable runnable) {
        if (runnable != null) {
            runnable.run();
        }
        return this;
     ...
     * @return
     */
    public OkHttpUtils3<T> onPostExecute(OnCompleteListener<T> listener) {
        mListener = listener;
        return this;
    }
     ...
     * @return
     */
    public OkHttpUtils3<T> targetClass(Class<T> clzz) {
        mClzz = clzz;
        return this;
    }
     ...
     */
    public void publishUpdate(int what,int percent) {
    ...
    public void downloadFile(Response response, File file, boolean showProgress) throws IOException {
        ...
        try {
            ...
            if (showProgress) {
                this.publishUpdate(DOWNLOADING_FINISH, 0);
            }
        } catch (IOException e) {
