...
import newer.project.fulicenter.BuildConfig;
import newer.project.fulicenter.activity.RecorderVideoActivity;
import newer.project.fulicenter.domain.VideoEntity;
import newer.project.fulicenter.video.util.ImageCache;
import newer.project.fulicenter.video.util.ImageResizer;
import newer.project.fulicenter.video.util.Utils;
import newer.project.fulicenter.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageThumbSize = getResources().getDimensionPixelSize(
				newer.project.fulicenter.R.dimen.image_thumbnail_size);
		mImageThumbSpacing = getResources().getDimensionPixelSize(
				newer.project.fulicenter.R.dimen.image_thumbnail_spacing);
		...
		mImageResizer.setLoadingImage(newer.project.fulicenter.R.drawable.empty_photo);
	...
	public View onCreateView(LayoutInflater inflater,
		...
		final View v = inflater.inflate(newer.project.fulicenter.R.layout.image_grid_fragment,
				container, false);
		final GridView mGridView = (GridView) v.findViewById(newer.project.fulicenter.R.id.gridView);
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			if (vEntty.size > 1024 * 1024 * 10) {
				String st = getResources().getString(newer.project.fulicenter.R.string.temporary_does_not);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView=LayoutInflater.from(mContext).inflate(newer.project.fulicenter.R.layout.choose_griditem, container,false);
				 holder.imageView=(RecyclingImageView) convertView.findViewById(newer.project.fulicenter.R.id.imageView);
				 holder.icon=(ImageView) convertView.findViewById(newer.project.fulicenter.R.id.video_icon);
				 holder.tvDur=(TextView)convertView.findViewById(newer.project.fulicenter.R.id.chatting_length_iv);
				 holder.tvSize=(TextView)convertView.findViewById(newer.project.fulicenter.R.id.chatting_size_iv);
			...
			String st1 = getResources().getString(newer.project.fulicenter.R.string.Video_footage);
			if(position==0)
			{
				holder.icon.setVisibility(View.GONE);
				holder.tvDur.setVisibility(View.GONE);
				holder.tvSize.setText(st1);
				holder.imageView.setImageResource(newer.project.fulicenter.R.drawable.actionbar_camera_icon);
			}else{
				...
				holder.imageView.setImageResource(newer.project.fulicenter.R.drawable.empty_photo);
