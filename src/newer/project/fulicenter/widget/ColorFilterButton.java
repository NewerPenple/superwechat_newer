package newer.project.fulicenter.widget;
...
public class ColorFilterButton extends Button {
    ...
    public ColorFilterButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext= (CategoryDetailActivity) context;
        mbtnTop=this;
        initGridView();
    }
