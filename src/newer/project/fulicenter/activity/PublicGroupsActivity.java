...
public class PublicGroupsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(newer.project.fulicenter.R.layout.activity_public_groups);
        initView();
        setQuery();
		seteListener();
    ...
    private void initView() {
        pb = (ProgressBar) findViewById(newer.project.fulicenter.R.id.progressBar);
        listView = (ListView) findViewById(newer.project.fulicenter.R.id.list);
        groupsList = new ArrayList<Group>();
        searchBtn = (Button) findViewById(newer.project.fulicenter.R.id.btn_search);
        View footView = getLayoutInflater().inflate(newer.project.fulicenter.R.layout.listview_footer_view, null);
        footLoadingLayout = (LinearLayout) footView.findViewById(newer.project.fulicenter.R.id.loading_layout);
        footLoadingPB = (ProgressBar)footView.findViewById(newer.project.fulicenter.R.id.loading_bar);
        footLoadingText = (TextView) footView.findViewById(newer.project.fulicenter.R.id.loading_text);
	...
	private class GroupsAdapter extends BaseAdapter implements SectionIndexer {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if (convertView == null) {
				convertView = inflater.inflate(newer.project.fulicenter.R.layout.row_group, null);
			}
            Group group = getItem(position);
            ((TextView) convertView.findViewById(newer.project.fulicenter.R.id.name)).setText(group.getMGroupName());
        ...
        public Object[] getSections() {
            ...
            for (int i = 1; i < count; i++) {
                ...
                Log.i(TAG, "groupadapter getsection getHeader:" + letter + " name:" + getItem(i).getMGroupName());
        ...
        private class  MyFilter extends Filter{
            ...
            protected synchronized FilterResults performFiltering(CharSequence prefix) {
                ...
                Log.i(TAG, "contacts original size: " + mOriginalList.size());
                Log.i(TAG, "contacts copy size: " + copyGroupList.size());
