package newer.project.superwechat.data;
...
public class OkHttpUtils2<T> {
     ...
     */
    public OkHttpUtils2<T> url(String url) {
        mUrl.append(url);
        return this;
    }
     ...
     * @return
     */
    public OkHttpUtils2<T> targetClass(Class<T> clzz) {
        mClzz = clzz;
        return this;
    }
    ...
    public void downloadFile(Response response, File file, boolean showProgress) throws IOException {
        ...
        try {
            ...
            if (showProgress) {
                OkHttpUtils2.publishUpdate(DOWNLOADING_FINISH, 0);
            }
        } catch (IOException e) {
