...
public class PickContactNoCheckboxActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(newer.project.superwechat.R.layout.activity_pick_contact_no_checkbox);
		listView = (ListView) findViewById(newer.project.superwechat.R.id.list);
		sidebar = (Sidebar) findViewById(newer.project.superwechat.R.id.sidebar);
		sidebar.setListView(listView);
		contactList = new ArrayList<Contact>();
		// 获取设置contactlist
		getContactList();
		// 设置adapter
		contactAdapter = new ContactAdapter(this, newer.project.superwechat.R.layout.row_contact, contactList);
