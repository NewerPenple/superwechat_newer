...
public class CallActivity extends BaseActivity {
    ...
    protected void saveCallRecord(int type) {
        ...
        String st1 = getResources().getString(newer.project.superwechat.R.string.call_duration);
        String st2 = getResources().getString(newer.project.superwechat.R.string.Refused);
        String st3 = getResources().getString(newer.project.superwechat.R.string.The_other_party_has_refused_to);
        String st4 = getResources().getString(newer.project.superwechat.R.string.The_other_is_not_online);
        String st5 = getResources().getString(newer.project.superwechat.R.string.The_other_is_on_the_phone);
        String st6 = getResources().getString(newer.project.superwechat.R.string.The_other_party_did_not_answer);
        String st7 = getResources().getString(newer.project.superwechat.R.string.did_not_answer);
        String st8 = getResources().getString(newer.project.superwechat.R.string.Has_been_cancelled);
        switch (callingState) {
        case NORMAL:
